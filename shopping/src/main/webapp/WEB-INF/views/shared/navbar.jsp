<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			<a class="navbar-brand" style="font-size: 3em;" href="${contextRoot}/home">Online-Shopping</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ">
					...
					<li class="nav-item" id="listproduct"><a class="nav-link" href="${contextRoot}/show/all/products">Products</a>
					</li>
